...
Calendar.dayMouseOver = function (ev) {
    ...
    if (el.ttip) {
        if (el.ttip.substr(0, 1) == "_") {
            ...
            el.ttip =date.print("D") + ", " + date.print("M") + " " + date.print("d") + ", " + date.print("y") ;  //Saturday, February 27, 2016
        }
...
Calendar.prototype.create = function (_par) {
    ...
    this._nav_clear = hh(Calendar._TT["CLEAR"], 1, 0);
    this._nav_clear.ttip = Calendar._TT["CLEAR"];
    this._nav_clear.width = 25;
    this._nav_clear.addEventListener('click', function () {
        if (window.calendar && window.calendar.sel) {
            window.calendar.sel.value = '';
        }
    });
...
Calendar.prototype._init = function (mondayFirst, date) {
    ...
    this.title.firstChild.data = year + "Y";
